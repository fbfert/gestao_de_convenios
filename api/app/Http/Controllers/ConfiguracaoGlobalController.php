...
class ConfiguracaoGlobalController extends Controller
{
    ...
    private function paraArray(ConfiguracaoGlobal $configuracao): array
    {
        return [
            ...
            'automacao_sincronizacao_clinica_diurno_intervalo_minutos' => $configuracao->automacao_sincronizacao_clinica_diurno_intervalo_minutos,
            'automacao_sincronizacao_clinica_noturno_horario_inicio' => $this->paraHorario($configuracao->automacao_sincronizacao_clinica_noturno_horario_inicio),
            'automacao_sincronizacao_clinica_noturno_horario_fim' => $this->paraHorario($configuracao->automacao_sincronizacao_clinica_noturno_horario_fim),
            'automacao_sincronizacao_clinica_noturno_intervalo_minutos' => $configuracao->automacao_sincronizacao_clinica_noturno_intervalo_minutos,
            'automacao_sincronizacao_clinica_madrugada_horario_inicio' => $this->paraHorario($configuracao->automacao_sincronizacao_clinica_madrugada_horario_inicio),
            'automacao_sincronizacao_clinica_madrugada_horario_fim' => $this->paraHorario($configuracao->automacao_sincronizacao_clinica_madrugada_horario_fim),
            'automacao_sincronizacao_clinica_madrugada_intervalo_minutos' => $configuracao->automacao_sincronizacao_clinica_madrugada_intervalo_minutos,
