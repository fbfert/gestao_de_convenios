...
class PermissionCatalog
{
    public const ROTULOS = [
        ...
        'antecipacoes.view' => 'Abrir a fila e o histórico de antecipações',
        'antecipacoes.manage' => 'Gerar, editar e excluir antecipações',
        ...
        'alertas.view' => 'Abrir a central de alertas',
