...
- [ ] 4.1 Transformar as linhas do analítico importado em dados processáveis de conciliação.
- [ ] 4.2 Calcular o valor pago por sessão e o repasse configurável por profissional.
