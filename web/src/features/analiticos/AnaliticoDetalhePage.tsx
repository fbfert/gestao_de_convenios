          ...
          <>
            <div className="grid gap-4 md:grid-cols-3 lg:grid-cols-4">
              <article className="rounded-3xl border border-white/10 bg-slate-950/40 p-4">
                ...
                <p className="mt-2 text-sm font-medium text-white">{data.lote.arquivo_nome_original}</p>
              </article>
              <article className="rounded-3xl border border-white/10 bg-slate-950/40 p-4">
                <p className="text-xs uppercase tracking-[0.25em] text-slate-400">Importado em</p>
              ...
              <article className="rounded-3xl border border-white/10 bg-slate-950/40 p-4">
                ...
                <p className="mt-2 text-sm font-medium text-white">{data.lote.status}</p>
              </article>
              <article className="rounded-3xl border border-white/10 bg-slate-950/40 p-4">
                <p className="text-xs uppercase tracking-[0.25em] text-slate-400">Saldo</p>
                <p className="mt-2 text-sm font-medium text-white">{data.lote.saldo_total}</p>
              </article>
            </div>

            <div className="grid gap-4 md:grid-cols-3">
              <article className="rounded-3xl border border-white/10 bg-slate-950/40 p-4">
                <p className="text-xs uppercase tracking-[0.25em] text-slate-400">Linhas analítico</p>
                <p className="mt-2 text-2xl font-semibold text-white">
                  {data.analitico.totais.linhas}
                </p>
                <p className="mt-1 text-sm text-slate-300">Total bruto: {data.analitico.totais.valor}</p>
              </article>
              <article className="rounded-3xl border border-white/10 bg-slate-950/40 p-4">
                <p className="text-xs uppercase tracking-[0.25em] text-slate-400">Linhas glosa</p>
                <p className="mt-2 text-2xl font-semibold text-white">{data.glosas.totais.linhas}</p>
                <p className="mt-1 text-sm text-slate-300">Total glosado: {data.glosas.totais.valor}</p>
              </article>
              <article className="rounded-3xl border border-white/10 bg-slate-950/40 p-4">
                <p className="text-xs uppercase tracking-[0.25em] text-slate-400">Conciliação</p>
                <p className="mt-2 text-2xl font-semibold text-white">
