    ...
    <div className="space-y-8" data-testid="medicos-page">
      <section className="space-y-4">
        <div>
          ...
          <h2 className="mt-2 text-3xl font-semibold text-white">Cadastro e referência de médicos</h2>
          ...
          <label className="block space-y-2">
            ...
            <input
              ...
              onChange={(event) =>
                setForm((current) => ({
                  ...current,
                  especialidade_medica: event.target.value,
                }))
              }
              className={selectClasses()}
